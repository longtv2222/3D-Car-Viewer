...
export default function Model(props: any) {
  ...
  if (props.myState.cars[props.myState.current] !== 'Scene') {
    return null
  }
    ...
    <group name="Scene" rotation={[0, 3.14, 0]} visible={props.visibility} ref={group} {...props} dispose={null}>
      <group position={[0, 0.71, 0]}>
        <group position={[0, 0.4, 0]} scale={[0.02, 0.02, 0.02]}>
          ...
          <mesh material-color={snap.items.interior} geometry={nodes.Plane010.geometry} material={materials.Rubber} position={[0, -1.6132, -100.1712]} />
          <mesh
