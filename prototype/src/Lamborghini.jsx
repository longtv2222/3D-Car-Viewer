...
function Larmborghini(props) {
    if (props.visibility == true) {
        const snap = useProxy(props.myState)
        const group = useRef()
        const { nodes, materials } = useGLTF('/lamborghini.glb')
        return (
            <group visible={props.visibility} name={'Lamborghini'} ref={group} {...props} scale={[0.007, 0.007, 0.007]} position={[0, 1.5, 0]} dispose={null}>
                <group rotation={[-Math.PI / 2, 0, 0]}>
                    <group rotation={[Math.PI / 2, 0, 0]}>
                        ...
                        <group position={[0.1381, -9.2425, -24.3809]} rotation={[0, 0, 0]} scale={[73.6118, 73.6118, 73.6118]}>
                            <mesh material-color={snap.items.exterior} geometry={nodes.object028_Material005_0.geometry} material={nodes.object028_Material005_0.material} />
                        </group>
                        ...
                        <group position={[0.1384, -11.6098, 36.3197]} rotation={[0, 0, 0]} scale={[73.6118, 73.6118, 73.6118]}>
                            <mesh material-color={snap.items.interior} geometry={nodes.object025_M_1_0.geometry} material={nodes.object025_M_1_0.material} />
                        </group>
                        ...
                        <group position={[0.1075, 2.2419, -143.5695]} rotation={[0, 0, 0]} scale={[73.6118, 73.6118, 73.6118]}>
                            <mesh material-color={snap.items.interior}
